...
def main(args):
    ...
    #     ckpt = torch.load(os.path.join(args.init_checkpoint, 'output_dir', 'merged_model.ckpt'), map_location=torch.device('cpu'))
    ...
    tokenizer.use_adameta = args.use_adameta
    ...
    if args.init_checkpoint:
        model_state_dict = {}
        checkpoint_path = os.path.join(args.init_checkpoint, 'checkpoint/mp_rank_00_model_states.pt')
